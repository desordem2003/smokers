  ...
  return `
    <section id="hero" style="background: #000; overflow: hidden;">
      <div class="hero-image-container" style="min-height: 500px; display: flex; align-items: center; justify-content: center; position: relative;">
        <img src="/assets/hero_banner.jpg" alt="SMOKE/RS Hero" class="hero-bg-img" fetchpriority="high" loading="eager" style="width: 100%; height: auto; display: block; min-height: 500px; object-fit: cover;">
